...
use Drupal\word_monitor\WordMonitorPluginCollection;
use PHPUnit\Framework\TestCase;

/**
 * Test WordMonitorPluginCollection.
 *
 * @group word_monitor
 */
class WordMonitorPluginCollectionTest extends TestCase {
  ...
  public function testPluginDefinitions(string $message, array $input, array $expected) {
    $object = $this->getMockBuilder(WordMonitorPluginCollection::class)
