...
// @codingStandardsIgnoreEnd
  ...
  // @codingStandardsIgnoreEnd
    ...
    // Drupal\{module_name}\Plugin\WordMonitorSearchPlugin\MyPlugin.
    $subdir = 'Plugin/WordMonitorSearchPlugin';
    ...
    $plugin_interface = WordMonitorSearchPluginInterface::class;

    // The name of the annotation class that contains the plugin definition.
    $plugin_definition_annotation_name = WordMonitorSearchPluginAnnotation::class;
    ...
    $this->setCacheBackend($cache_backend, 'word_monitor_search_plugin');
  }
